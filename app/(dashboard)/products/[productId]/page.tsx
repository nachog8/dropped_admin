...
import React, { useEffect, useState, useCallback } from 'react'; // Importa React y hooks necesarios
...
const ProductDetails = ({ params }: { params: { productId: string }}) => {
  ...
  }, [params.productId]); // Agrega params.productId como dependencia
  ...
  }, [getProductDetails]); // Agrega getProductDetails como dependencia
